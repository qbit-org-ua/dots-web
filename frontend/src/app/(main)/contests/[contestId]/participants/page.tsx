            ...
            <TableBody>
              {filtered.map((u) => (
                <TableRow key={u.user_id}>
                  <TableCell className="font-mono text-gray-600">{u.user_id}</TableCell>
                  <TableCell>
                    <span className="font-medium">{u.nickname}</span>
                    {u.fio && <span className="text-gray-500"> - {u.fio}</span>}
                  </TableCell>
                  <TableCell className="text-gray-600">{u.u_institution_name || '-'}</TableCell>
                  <TableCell>
                    <span
                      className={
                        u.reg_status === 3
